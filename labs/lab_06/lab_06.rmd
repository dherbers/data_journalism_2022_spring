...
```{r}
international_migration <- read_csv("data/tabula-md-statistical-handbook.csv", skip=2, col_names=c("state_jurisdiction", "july_2011", "july_2012", "july_2013", "july_2014", "july_2015", "july_2016", "july_2017", "july_2018", "july_2019", "total"))
```
...
**A1** The Suburban Washington Region, Montgomery County, and Baltimore City are the region, county, and city that account for the largest percentages
...
**A2** In A1 we produced data that shows which region, county, and city contributed the most of population of international migrants in Maryland by calculating the percentage of international time period over all of the years that were available.
...
**A3** The region with the highest percentage change is the Southern Maryland Region, and the jurisdiction with the highest percentage change is Calvert
...
**A4** Those changes probably occurred because that jurisdiction is run by all Republicans, and I would guess that they may have come to power and changed policies between July 2017 and 2018.
...
```{r}
domestic_migration <- read_csv("data/tabula-md-statistical-handbook-domestic.csv", skip=2, col_names=c("state_jurisdiction", "july_2011", "july_2012", "july_2013", "july_2014", "july_2015", "july_2016", "july_2017", "july_2018", "july_2019", "total"))
```
...
**A7** I would describe this data as consistent with my expectations of Maryland because the large amounts of migration are centered in the areas with large populations, like Anne Arundel. I think the part that stands out is the Calvert County area because it had seen such a sharp decrease in international migration, but still has a large amount of domestic increase.
