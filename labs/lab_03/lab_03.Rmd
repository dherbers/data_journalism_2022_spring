...
A2: The zip code 25301 had the highest amount of loans by dollar amount, which is in Charleston in Kanawha county. The Eye and Ear Clinic of Charleston DBA Charleston Surgical got the largest loan by dollar value with a total of $1,520,007, and it's forgiveness amount was $1,538,254.68. The forgiveness amount was larger, most likely meaning that the loan had accrued interest and that interest was also forgiven.
...
A3: The businesses are DM MOTOR, INC, DUTCH MILLER OF CHARLESTON, INC, DUTCH MILLER OF CHARLOTTE, INC, 	DUTCH MILLER SUBARU, INC, DUTCH MILLER CHEVROLET, INC. The businesses are are car dealerships and sales lots. In total, the five businesses got $3,105,300, and have had 101.13% of their loans forgiven. Carol Miller voted yes on the CARES Act, and she was involved in introducing CARES funding for low income housing. 
...
wv_rep %>%
  summarise(total_amount = sum(amount), total_forgiveness = sum(forgiveness_amount)) %>%
