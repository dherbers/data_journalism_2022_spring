...
**A6** All three zipcodes (21031, 20701, 21240) are in areas with extremely small populations, one of them is actually an airport, so the business owners probably do not live in the same zipcode that their business exists in, and the ZCTA data goes off of where populations actually live.
