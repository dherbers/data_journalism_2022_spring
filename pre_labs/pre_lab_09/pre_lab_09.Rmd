...
**Answer**
The code is counting the total loans per county, organizing them to show the most first, and then showing just the counties and totals first ten.
```{r}
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer**
a basic black and white bar chart of the 10 counties, but the labels are overlapping and it isn't in a specific order
...
**Answer**
the bar chart is organized from smallest to largest now
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer**
the bar chart is sideways now, so the labels are not overlapping
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer**
the background of the bar chart isn't gray now, there's just gray grid lines
...
**Answer**
the background is light blue and some of the grid lines have gone away, the labels are all caps but are overlapping again
```{r}
maryland_ppp_top_counties %>%
  ggplot() +
  geom_bar(aes(x=reorder(project_county_name,total_loans), weight=total_loans)) +
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer**
the chart has a title now, as well as axis labels that have meaning and a source caption
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer**
a dataframe with total loans per date has appeared
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer**
a line graph has appeared, it is very squiggly
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer**
the squiggles are easier to see, but now the labels are overlapping too much to read
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer**
the labels have been rotated a bit so they no longer overlap and can be read
