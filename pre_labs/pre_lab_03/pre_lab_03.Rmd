...
**Answer**:
135073, the same amount as both above. Maybe those loans have not been forgiven or the business hasn't applied for forgiveness year.
...
**Answer**
There aren't any loans in the data for October 2020
...
**Answer**
10,000,000 is the largest, 6 is the smallest. The largest is not that suspicious to me because it is the maximum, but it is probably worth seeing who got it. A 6 dollar loan is very suspicious though, because that amount of money is insignificant, so why apply at all?
...
**Answer**
There's a duplicate of one of the rows of data, there's a city entry that's all capitalized, and several city entries are misspelled. The zipcodes are also inconsistent.
...
**Answer**
The code added an x infront of the column name, making it start with a letter instead of a number. 
...
**Answer**
There's a problem with summarizing the column named total_amount, and r is not recognizing the entry as characters. I think the formatting of the data is probably weird and needs to be changed.
...
**Answer**
1 duplicate, 2 entries of Stuart Jones LLC
