...
**Answer**
There are some tables, all formatted differently, that contain information about naics codes and industry sectors. The table that we looked at inexplicably has the second column aligned to the right.
...
**Answer**
The table is organized into a bunch of pieces of code that seem to have numbers that correspond to the rows.
...
**Answer**
the html appears, with the head and body tags visible, and it is saved to naics_industry and shows the text List of 2
...
**Answer**
It shows the html split into sections based on the page structure.
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer**
a sidebar pops up with the portion of code for the sector box highlighted
...
**Answer**
It shows all of the tables from the webpage
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer**
There are now 6 options, they describe the rows inside of them
...
**Answer**
the scroll icon opens up the dataframe
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer**
it opened a different dataframe
...
**Answer**
The dataframe that we want is now the only one
...
**Answer**
the alignment of the table has changed
```{r}
# Read in all html from table, store all tables on page as nested list of dataframes.
naics_industry <- naics_url %>%
  read_html() %>%
...
**Answer**
the same table from the last chapter opened
```{r}
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
tables with strange links, footnotes and formatting
...
**Task** Run the following code to read in the html. Briefly describe the output that appears below the codeblock.
**Answer**
employment_info with List of 2
```{r}
...
**Answer**
it is now focused on the one table we want
...
**Answer**
a dataframe with six rows appears
...
**Answer**
one row with just the employment number for nov 2021
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
another webpage with several different tables
...
**Answer**
each industry appears with [1] before it
```{r}
...
**Answer**
error because it can't find sector_list
```{r, error=TRUE}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer**
the same output of sector names appeared
```{r}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer**
error because sector_name is not found
```{r, error=TRUE}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Answer**
the naics industry dataframe appears
```{r}
...
**Answer**
the employment number from nov 2021
...
**Task** Run the following code to load table from last chapter. Briefly describe the output that appears below the codeblock.
**Answer**
the dataframe of sectors appears
```{r}
# Define url of page we want to scrape
...
**Answer**
a column with urls has been added
...
**Answer**
there's a column with the table ids
```{r}
...
**Answer**
public administration has been filtered out
...
**Answer**
the urls and xpaths have been saved as values
```{r}
...
**Answer**
there's now nested dataframes under each_row_df
```{r}
...
**Answer**
now the dataframes only have employment data
...
**Answer**
now the data for other months is back
...
**Task** Run the following for loop to clean up tables. Briefly describe the output that appears below the codeblock.
**Answer**
the tables are cleaner with different column names
```{r}
...
**Answer**
now the data is all in one tibble
```{r}
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
a table with only unemployment value
...
**Answer**
the value for agriculture is now N/A
```{r}
