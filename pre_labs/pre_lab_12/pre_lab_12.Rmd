...
**Answer**
data frame with lots of N/A and various totals for specific days
```{r}
...
**Answer**
The tibble has a lot of values of 1 and 8,000 ish, it seems to me like the data may be input incorrectly because the values aren't consistent.
...
**Answer**
The numbers look like they have consistently declined in the most recent 7 days.
...
**Answer**
Vaccinations have declined overall, with some small spikes.
...
**Answer**
The chart shows a major surge in covid infections in january, particularly in Montgomery and Prince George's counites, as well as Baltimore/City
...
**Task** Run the following code and describe what the resulting chart shows
**Answer**
The chart is much more crowded and has a crazy unknown line.
```{r}
...
**Answer**
The map shows covid cases by county in Maryland yesterday.
