...
**Answer**
All of the cities are in different cases, some are all capitalized, some are all lowercase, and some are a mixture.
...
**Answer**
Refinr changed PHOENIX to Phoenix and WESTMINSTER to Westminster, making them title case.
...
**Answer**
Refinr changed all of the iterations of Aberdeen, Abingdon, and Arlington to title case.
...
**Answer**
No, there were no substantial changes to the data.
