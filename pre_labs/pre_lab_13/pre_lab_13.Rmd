...
**Answer**
a scatter plot also showing a trend line and shadow 
```{r}
...
**Task** Run the following code. Describe the plot. What do you see?
**Answer**
a similar plot, but the trends vs. the dots look less clear
```{r}
...
**Answer**
0.52 correlation, which isn't a super meaningful result
```{r}
