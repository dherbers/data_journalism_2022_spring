...
**Answer** https://datawrapper.dwcdn.net/FTASF/1/
...
**Answer** The code is totaling the amount of loans per county then displaying the counties with their totals.
...
**Answer** The code is filtering out counties with less than 6 loans.
...
**Answer** The new column has a fips code that combines the state code and county code.
...
**Answer** There are a bunch of columns, including two columns with county names in different syntaxes.
...
**Answer** The map now only shows Maryland rather than the entire US
...
**Answer** Hovering over counties now shows their name and totals. 
...
**Answer** https://datawrapper.dwcdn.net/bnkbj/1/
